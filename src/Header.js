                ...
                <ul style={menuListStyle}>
                    ...
                    >
                        ...
                        {activeDropdown === 'SmartFactory' && (
                            <ul style={dropdownStyle}>
                                <li><Link to="/SmartFactory/1/intro" style={dropdownItemStyle}>DDI Demo</Link></li>
                                <li><Link to="/SmartFactory/2/intro" style={dropdownItemStyle}>Fire Detection</Link></li>
